    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      <section id="details" className="px-4 py-12 bg-slate-800/50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8 bg-cyan-900/20 border border-cyan-700 rounded-xl p-8">
            <h3 className="text-xl font-bold text-cyan-300 mb-4">
              📝 Add Your Course Content Here
            </h3>
            <p className="text-gray-300">
              Edit this file at <code className="bg-slate-800 px-2 py-1 rounded">app/docker/page.tsx</code>
